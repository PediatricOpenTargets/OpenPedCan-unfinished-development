...
```{r}
### cnvs
vroom::vroom('../../../OpenPedCan-analysis/data/consensus_wgs_plus_cnvkit_wxs.tsv') %>%
...
vroom::vroom('../../../OpenPedCan-analysis/data/independent-specimens.rnaseq.primary.tsv') -> rnaseq_independent_specs
```
